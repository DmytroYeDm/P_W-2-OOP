...
/* 
[+] 4. Для організації доступу та ініціалізації даних класу перевантажити
операції “[ ]” та/або “( )”. Дані операції можна не перевантажувати для стеків,
черг, кілець.

[+] 5. Перевантажте операції “>>” та “<<” для введення з консолі та
виведення на консоль.

[+] 6. Дати інтерпретацію та перевантажити операцію перетворення типу.
Для варіантів завдань на 19max і на 20max це може бути перетворення об'єкту
до одно- або двовимірного масиву.

[+] 7. Перевантажити операції “==” і “!=“ порівняння об'єктів на рівність і на
не рівність. Для сутностей, на множині яких визначене відношення порядку,
перевантажити операції “>” та “<” або “>=” і “<=” для порівняння на
більше/менше або на більше-рівно/менше-рівно.

[+] 8. Перевантажити операцію присвоювання. Операції скороченого
присвоювання перевантажувати необов'язково.
*/